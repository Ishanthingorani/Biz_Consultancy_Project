...
-- 12. Which is best selling prodcut and category.
...
-- 14. retriev the business name that took services more than 5 times 
...
-- 15. Find a doctor who have their own clinic
...
-- 16. just find out city with less than 10 business meetings 
...
-- 17. Find the customer who have more than one businesses
...
-- 18. calculate the sales and profit ratio of only health realted business
...
-- 19. Update the business owner name if it is more than 40 characters 

select contact_person, length(contact_person) as len 
from business_info 
where length(Contact_Person) > 40 ;


-- 	20 calculate profit and sales based on city, year respected BDM and Tele
